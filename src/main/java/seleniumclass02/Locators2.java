...
//confirm that you have logged in the website
        ...
        System.out.println(text);//prints "Welcome, Tester! | Logout"
        //confirming
        //by using title
        /* press CTRL F--> a search bar will appear where you can enter "title"--->press ENTER
        it shows the title in DOM
         */
        String title=driver.getTitle();
        System.out.println(title);//prints "Web Orders"
